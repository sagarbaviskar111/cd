        ...
        <div className="container">
            <div className="row no-gutters slider-text align-items-end">
                <div className="col-md-9 ftco-animate pb-5">
                    ...
                    <h1 className="mb-0 bread">Clinical Research &amp; Pharmacovigilance</h1>
                </div>
            </div>
        </div>
    </section>
  ...
  <div className="container">
    <div className="row mb-5 text-center">
      <div className="col-lg-10 offset-lg-1">
        ...
        <h2 className="cr-subtitle">in Clinical Research &amp; Pharmacovigilance</h2>
        <p className="cr-desc">Kickstart your career with this 6-month live, online certification program designed for students and freshers entering Clinical Research & Pharmacovigilance. Learn industry-relevant skills with live mentorship, real case studies, and practical exposure that prepare you for top roles in pharma, healthcare & CROs.</p>
      </div>
    </div>
    ...
    <div className="row justify-content-center mb-5">
      ...
      <div className="col-lg-5 col-md-6 mb-4">
        <div className="cr-module-card">
          ...
          <ul className="cr-list">
            <li>Drug Development Process &amp; Clinical Trial Phases (I–IV)</li>
            <li>Global Guidelines: ICH-GCP, Indian GCP, FDA, EMA</li>
            <li>Trial Design, Protocol Development &amp; Site Management</li>
            <li>Essential Documents: IB, ICF, CRF, TMF</li>
            <li>Monitoring, Patient Recruitment &amp; Safety Reporting</li>
            <li>Quality Control, Audits &amp; SOP Implementation</li>
          </ul>
        </div>
      </div>
      ...
      <div className="col-lg-5 col-md-6 mb-4">
        <div className="cr-module-card">
          ...
          <ul className="cr-list">
            <li>Drug Safety &amp; Adverse Drug Reactions (ADRs)</li>
            <li>ICSR Processing, Narrative Writing &amp; Case QC</li>
            <li>Causality Assessment &amp; MedDRA Coding</li>
            <li>Aggregate Reports: PSUR, PBRER, RMP</li>
            <li>Signal Detection &amp; Risk Management Planning</li>
            <li>Global PV Regulations: FDA, EMA, ICH, WHO</li>
          </ul>
        </div>
    </div>
        ...
        <div className="cr-outcomes-wrap d-flex flex-column justify-content-center h-100">
          ...
          <div className="cr-outcome-card">
            ...
            <div className="cr-outcome-text">
              ...
              <p>DSA, PV Executive, CRC, CTA roles</p>
            </div>
          </div>
