        ...
        <div className="container">
            <div className="row no-gutters slider-text align-items-end">
                <div className="col-md-9 ftco-animate pb-5">
                    ...
                    <h1 className="mb-0 bread">Clinical Research &amp; Medical Writing</h1>
                </div>
            </div>
        </div>
    </section>
  ...
  <div className="container">
    <div className="row mb-5 text-center">
      <div className="col-lg-10 offset-lg-1">
        ...
        <h2 className="cr-subtitle">in Clinical Research &amp; Medical Writing</h2>
        <p className="cr-desc">A comprehensive 6-month live online certification designed for students and professionals seeking a rewarding career. Get hands-on exposure to essential documents, global guidelines, and real-world writing assignments guided by industry mentors.</p>
      </div>
    </div>
    ...
    <div className="row justify-content-center mb-5">
      ...
      <div className="col-lg-5 col-md-6 mb-4">
        <div className="cr-module-card">
          ...
          <h3 className="cr-module-title">Medical Writing</h3>
          <ul className="cr-list">
