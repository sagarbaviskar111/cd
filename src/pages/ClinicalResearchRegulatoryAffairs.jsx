  ...
  useEffect(() => {
    ...
    fetch('http://localhost:5000/api/courses')
      ...
      .then(data => {
        ...
        const crraCourse = data.find(item => item.CRRA);
        if (crraCourse) {
          setCourseData(crraCourse.CRRA);
        }
      })
      ...
      <div class="col-lg-5 col-md-6 mb-4">
        <div class="cr-module-card">
          ...
          <ul class="cr-list">
            ...
            <li>Clinical Trial Documents: IB, ICF, CRF, TMF</li>
            <li>Trial Execution, Monitoring &amp; AE/SAE Reporting</li>
            <li>Compliance Management, Audits &amp; SOPs</li>
          </ul>
        </div>
      </div>
      <!-- Module 2 -->
      <div class="col-lg-5 col-md-6 mb-4">
        <div class="cr-module-card">
          ...
          <ul class="cr-list">
            ...
            <li>IND, NDA, ANDA, DMF Filing Process</li>
            <li>Regulatory Submission Pathways</li>
            <li>Labeling, Advertising &amp; Post-Marketing PV</li>
          </ul>
        </div>
      </div>
    </div>
