        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    ...
                    <h1 class="mb-0 bread">Clinical Research &amp; Pharmacovigilance</h1>
                </div>
            </div>
        </div>
    </section>
