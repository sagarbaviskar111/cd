...
const ClinicalResearchCrPvDm = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${BASE_URL}/api/courses`)
      .then(res => res.json())
      .then(data => {
        // Find the object with "CRPVDM" key
        const crpvdmCourse = data.find(item => item.CRPVDM);
        if (crpvdmCourse) {
          setCourseData(crpvdmCourse.CRPVDM);
        }
      })
        ...
        <div className="container">
            <div className="row no-gutters slider-text align-items-end">
                <div className="col-md-9 ftco-animate pb-5">
                    ...
                    <h1 className="mb-0 bread">Clinical Research, Pharmacovigilance &amp; Data Management</h1>
                </div>
            </div>
        </div>
    </section>
...
<style>{`
  ...
  .cr-icon-3 { background: #dcfce7; color: #16a34a; }
  ...
  <div className="container">
    <div className="row mb-5 text-center">
      <div className="col-lg-10 offset-lg-1">
        ...
        <h2 className="cr-subtitle">in Clinical Research, Pharmacovigilance &amp; Data Management</h2>
        <p className="cr-desc">A comprehensive 6-month live, online certification program designed to master Clinical Research, Drug Safety, and Clinical Data Management. Engage with live mentorship, analyze real case studies, and receive robust placement preparation tailored for elite pharma and CRO roles.</p>
      </div>
    </div>
    ...
    <div className="row mb-5">
      ...
      <div className="col-lg-4 col-md-6 mb-4">
        <div className="cr-module-card">
          ...
          <ul className="cr-list">
            <li>Trial Design &amp; Protocol Dev.</li>
            <li>ICH-GCP &amp; Regulatory Guidelines</li>
      ...
      <div className="col-lg-4 col-md-6 mb-4">
        <div className="cr-module-card">
          ...
          <h3 className="cr-module-title">Pharmacovigilance</h3>
          <ul className="cr-list">
            <li>ADR Reporting &amp; ICSR Processing</li>
            <li>MedDRA Coding &amp; Signal Detection</li>
            <li>Aggregate Reports &amp; PV Compliance</li>
          </ul>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6 mb-4">
        <div className="cr-module-card">
          <div className="cr-icon-box cr-icon-3">
            💾
          </div>
          <h3 className="cr-module-title">Data Management</h3>
          <ul className="cr-list">
            <li>CRF Design &amp; EDC Tools</li>
            <li>CDISC Standards &amp; Data Cleaning</li>
            <li>Database Lock &amp; Data Transfer</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div className="row align-items-stretch mb-5">
      <div className="col-lg-6 mb-4">
        <div className="cr-details-box d-flex flex-column justify-content-center">
          ...
          <div className="cr-detail-item">
            ...
            <div className="cr-detail-text">
              <h4>Eligibility</h4>
              <p style={{"fontSize":"16px"}}>BPharm, MPharm, Pharm.D, BSc, MSc, MBBS &amp; Life Sciences</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-6">
        <div className="cr-outcomes-wrap">
          ...
          <div className="cr-outcome-card">
            ...
            <div className="cr-outcome-text">
              ...
              <p>Valid credential for leading CROs &amp; Pharma</p>
            </div>
          </div>
          ...
          <div className="cr-outcome-card">
            ...
            <div className="cr-outcome-text">
              ...
              <p>Resume building &amp; dedicated interview prep</p>
            </div>
          </div>
        </div>
      </div>
