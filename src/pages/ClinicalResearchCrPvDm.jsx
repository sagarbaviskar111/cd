        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    ...
                    <h1 class="mb-0 bread">Clinical Research, Pharmacovigilance &amp; Data Management</h1>
                </div>
            </div>
        </div>
    </section>
  ...
  <div class="container">
    <div class="row mb-5 text-center">
      <div class="col-lg-10 offset-lg-1">
        ...
        <h2 class="cr-subtitle">in Clinical Research, Pharmacovigilance &amp; Data Management</h2>
        <p class="cr-desc">A comprehensive 6-month live, online certification program designed to master Clinical Research, Drug Safety, and Clinical Data Management. Engage with live mentorship, analyze real case studies, and receive robust placement preparation tailored for elite pharma and CRO roles.</p>
      </div>
    </div>
    ...
    <div class="row mb-5">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="cr-module-card">
          ...
          <h3 class="cr-module-title">Pharmacovigilance</h3>
          <ul class="cr-list">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="cr-module-card">
          <div class="cr-icon-box cr-icon-3">
            💾
          </div>
          <h3 class="cr-module-title">Data Management</h3>
          <ul class="cr-list">
