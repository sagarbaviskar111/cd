...
const CourseCrPv = () => {
  ...
  const brochureLink = courseData?.pdf ? `http://localhost:5000/${courseData.pdf}` : 'images/advance.pdf';
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-end">
                <div class="col-md-9 ftco-animate pb-5">
                    ...
                    <h1 class="mb-0 bread">Clinical Research &amp; Clinical Data Management</h1>
                </div>
            </div>
        </div>
    </section>
  ...
  <div class="container">
    <div class="row mb-5 text-center">
      <div class="col-lg-10 offset-lg-1">
        ...
        <h2 class="cr-subtitle">in Clinical Research &amp; Clinical Data Management</h2>
        <p class="cr-desc">A 6-month online, mentor-led program with real projects, live sessions &amp; comprehensive placement support. Become job-ready for exciting roles in top CROs, pharma companies, and hospitals.</p>
      </div>
    </div>
    ...
    <div class="row justify-content-center mb-5">
      ...
      <div class="col-lg-5 col-md-6 mb-4">
        <div class="cr-module-card">
          ...
          <h3 class="cr-module-title">Clinical Data Management</h3>
          <ul class="cr-list">
