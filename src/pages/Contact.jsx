...
<div className="wrap">
  ...
  <div className="container py-5 contact">
    <div className="bg-light p-5 rounded shadow text-center">
      <h1 className="mb-4">Contact Clinidea</h1>
      <p className="mb-4">Reach out, follow us, or join our community. We’re just a click away!</p>

      <div className="row g-4 justify-content-center">
        
        <div className="col-md-4">
          <div className="contact-card p-4 text-center" style={{"transformStyle":"preserve-3d"}}>
            <div className="icon-circle bg-primary mb-3" style={{"margin":"0 auto"}}>
        ...
        <div className="col-md-4">
          <div className="contact-card p-4 text-center" style={{"transformStyle":"preserve-3d"}}>
            ...
            <h5>Follow Us</h5>
            <p className="mb-3">Join our socials for updates, free resources and community events.</p>
            <div className="follow-group flex-column">
              <a href="https://wa.me/919370472071" target="_blank" className="btn-3d btn-3d--whatsapp social-btn" aria-label="WhatsApp">
              ...
              <a href="https://www.linkedin.com/company/clinidea-education" target="_blank" className="btn-3d btn-3d--linkedin social-btn" aria-label="LinkedIn">
              ...
              <a id="ig-link" href="https://www.instagram.com/clinidea.education?igsh=MTVvcm9uaWRudTM2bA==" target="_blank" className="btn-3d btn-3d--instagram social-btn" aria-label="Instagram">
        ...
        <div className="col-md-4">
          <div className="contact-card p-4 text-center" style={{"transformStyle":"preserve-3d"}}>
            ...
            <h5>Email Us</h5>
            <p className="mb-3">We'll get back within 24 hours on working days.</p>
            <p className="mb-3"><a href="mailto:clinideaeducation@gmail.com" className="d-block">clinideaeducation@gmail.com</a></p>
            <a href="mailto:clinideaeducation@gmail.com" className="btn-3d btn-3d--group" aria-label="Email us">
              📧 Email Us
            </a>
          </div>
        </div>
      ...
      <div className="text-center mt-4">
        <a href="https://chat.whatsapp.com/FdjVRzRkl9e9OLi3ItW6SZ" target="_blank" className="btn-3d btn-3d--group" aria-label="Join WhatsApp Group">
          📲 Join Our WhatsApp Group
        </a>
      </div>

      <p className="mt-3">Or visit us at: <a href="mailto:clinideaeducation@gmail.com" className="text-primary">clinideaeducation@gmail.com</a></p>
    </div>
  </div>
